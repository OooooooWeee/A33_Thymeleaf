...
for(var a=0;a<member.length;a++){
    datas.push(
        {
            id:member1[a].id,name:member1[a].Name,
            shop:member1[a].ShopName,
            position:member1[a].Position,
            workdaypreference:member1[a].DaylikeStart + "~" + member1[a].DaylikeEnd,
            hourspreference:member1[a].TimelikeStart + "~" + member1[a].TimelikeEnd,
            timepreference:member1[a].Timelong,
